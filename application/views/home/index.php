                            ...
                            <div class="hotale-navigation hotale-item-pdlr clearfix">
                                <div class="hotale-main-menu" id="hotale-main-menu">
                                    <ul id="menu-main-navigation-1" class="sf-menu">
                                        ...
                                        <li class="menu-item menu-item-has-children hotale-normal-menu">
                                            <a href="room-grid-style-1.html" class="sf-with-ul-pre">Facilities</a>
                                        </li>
                                        <li class="menu-item menu-item-has-children hotale-normal-menu">
                                            <a href="blog-full-right-sidebar.html" class="sf-with-ul-pre">reservation</a>
                                            <ul class="sub-menu">
                                            </ul>
                                        </li>
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                                    <div class="gdlr-core-text-box-item-content" style="font-size: 22px; font-weight: 400; text-transform: none; color: #ffffff;"><p>Enjoy Your Holiday with Adi Abian Villa</p></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <ul class="slides">
                                                            <li>
                                                                <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="<?php echo base_url('asset/images/ss1.png')?>"
                                                                            alt=""
                                                                            width="600"
                                                                            height="600"
                                                            ...
                                                            <li>
                                                                <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="<?php echo base_url('asset/images/ss2.png')?>"
                                                                            alt=""
                                                                            width="600"
                                                                            height="600"
                                                            ...
                                                            <li>
                                                                <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="<?php echo base_url('asset/images/ss3.png')?>"
                                                                            alt=""
                                                                            width="600"
                                                                            height="600"
                                                            ...
                                                            <li>
                                                                <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="<?php echo base_url('asset/images/ss4.png')?>"
                                                                            alt=""
                                                                            width="600"
                                                                            height="600"
                                                            ...
                                                            <li>
                                                                <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="<?php echo base_url('asset/images/ss5.png')?>"
                                                                            alt=""
                                                                            width="600"
                                                                            height="600"
                                                            ...
                                                            <li>
                                                                <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="<?php echo base_url('asset/images/ss6.png')?>"
                                                                            alt=""
                                                                            width="600"
                                                                            height="600"
                                                            ...
                                                            <li>
                                                                <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="<?php echo base_url('asset/images/ss7.png')?>"
                                                                            alt=""
                                                                            width="600"
                                                                            height="600"
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                                    <a
                                                        ...
                                                        href="https://www.instagram.com/adiabianvi?igsh=dmZ2cTVnMmI2bGd4"
                                                        target="_blank"
