...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/goodlayers-core/plugins/elegant/elegant-font.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/goodlayers-core/plugins/ionicons/ionicons.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/goodlayers-core/plugins/simpleline/simpleline.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/goodlayers-core/plugins/gdlr-custom-icon/gdlr-custom-icon.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/goodlayers-core/plugins/style.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/goodlayers-core/include/css/page-builder.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/tourmaster/tourmaster.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/css/tourmaster-global-style-custom.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url('asset/js/plugins/tourmaster/room/tourmaster-room.css') ?>" type="text/css" media="all" />
...
<body class="home page-template-default page page-id-14980 theme-hotale gdlr-core-body tourmaster-body woocommerce-no-js hotale-body hotale-body-front hotale-full hotale-with-sticky-navigation hotale-blockquote-style-3 gdlr-core-link-to-lightbox" data-home-url="index.html">
                ...
                <div class="hotale-mobile-menu-right">
                    ...
                    <div class="hotale-mobile-menu">
                        ...
                        <div class="hotale-mm-menu-wrap hotale-navigation-font" id="hotale-mobile-menu" data-slide="right">
                            ...
                            <li class="menu-item menu-item-has-children">
                                <a href="blog-full-right-sidebar.html">About Us</a>
        ...
        <div class="hotale-body-wrapper clearfix hotale-with-transparent-header hotale-with-frame">
                ...
                <div class="gdlr-core-page-builder-body">
                    <div class="gdlr-core-pbf-wrapper gdlr-core-wrapper-full-height gdlr-core-js gdlr-core-full-height-center" style="margin: 0px 0px 0px 0px; padding: 280px 0px 80px 0px; border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;" id="gdlr-core-wrapper-1" data-decrease-height="40px">
                        <div class="gdlr-core-pbf-background-wrap" style="border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;">
                            <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url('asset/images/ab13.jpg'); background-size: cover; background-position: center;" data-parallax-speed="0"></div>
                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                                    <div class="gdlr-core-text-box-item-content" style="font-size: 22px; font-weight: 400; text-transform: none; color: #ffffff;">
                                                        <p>Enjoy Your Holiday with Adi Abian Villa</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="tourmaster-room-search-item tourmaster-item-pdlr clearfix">
                                                    <form class="tourmaster-room-search-form tourmaster-radius-round tourmaster-style-box tourmaster-align-horizontal" action="room-search.html" method="get">
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                    <div class="gdlr-core-text-box-item-content" style="text-transform: none; color: #0a0a0a;">
                                                        <p>
                                                            <span style="font-size: 55px; font-weight: 500; margin-right: 12px; letter-spacing: 4px;">3</span>
                                                            <span class="mmr30" style="font-size: 22px; font-weight: 400; margin-right: 80px; letter-spacing: 7px;">stars</span>
                                                            <span style="font-size: 55px; font-weight: 500; margin-right: 12px; letter-spacing: 4px;">10</span>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                    <div class="gdlr-core-text-box-item-content" style="font-size: 34px; line-height: 1.4; font-weight: 400; letter-spacing: 5px; text-transform: none; color: #0a0a0a;">
                                                        <p>This villa is located in a strategic location, namely close to the Uluwatu tourist attraction.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align" style="padding-bottom: 0px;">
                                                    <div class="gdlr-core-image-item-wrap gdlr-core-media-image gdlr-core-image-item-style-round2 gdlr-core-image-item-style-round" style="border-width: 0px; max-width: 550px; border-radius: 50px 0px 50px 0px; -moz-border-radius: 50px 0px 50px 0px; -webkit-border-radius: 50px 0px 50px 0px;">
                                                        <img src="<?php echo base_url('asset/images/adib.png') ?>" alt="" width="1000" height="1130" title="resort-swim" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                                    <div class="gdlr-core-image-item-wrap gdlr-core-media-image gdlr-core-image-item-style-rectangle" style="border-width: 0px; max-width: 1091px;">
                                                        <img src="<?php echo base_url('asset/images/adib2.png') ?>" alt="" width="1381" height="672" title="resort-group" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="gdlr-core-pbf-wrapper" style="padding: 80px 0px 15px 0px;" id="gdlr-core-wrapper-3">
                        <div class="gdlr-core-pbf-background-wrap">
                            <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(upload/Square.png); background-repeat: no-repeat; background-position: top center;" data-parallax-speed="0"></div>
                        </div>
            ...
            <div class="gdlr-core-pbf-wrapper" style="padding: 50px 0px 200px 0px;" id="gdlr-core-wrapper-4">
                ...
                <div class="gdlr-core-pbf-background-wrap" style="top: -70px;">
                    <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(upload/Group-36.jpg); background-repeat: no-repeat; background-position: top center;" data-parallax-speed="0"></div>
                </div>
                <div class="gdlr-core-pbf-wrapper-content gdlr-core-js">
                    <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container-custom" style="max-width: 1000px;">
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align gdlr-core-no-p-space" style="padding-bottom: 0px;">
                                            <div class="gdlr-core-text-box-item-content" style="font-size: 21px; font-weight: 400; letter-spacing: 0px; text-transform: none; color: #898989;">
                                                <p>Enjoy our exceptional facilities to make your vacation even more relaxing. We strive to provide everything you need for a memorable and stress-free stay.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation="fadeInDown" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8">
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                            <i class="gdlr-core-icon-item-icon gdlr-icon-dish" style="color: #212121; font-size: 62px; min-width: 62px; min-height: 62px;"></i>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                            <div class="gdlr-core-title-item-title-wrap">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 20px; font-weight: 500; letter-spacing: 0px; text-transform: none; color: #000000;">
                                                    Kitchen<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="gdlr-core-pbf-column gdlr-core-column-12" id="gdlr-core-column-12">
                            <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="padding: 70px 0px 0px 0px;">
                                ...
                                <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation="fadeInDown" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8">
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                            <i class="gdlr-core-icon-item-icon gdlr-icon-wifi-signal" style="color: #212121; font-size: 62px; min-width: 62px; min-height: 62px;"></i>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                        ...
                        <div class="gdlr-core-pbf-column gdlr-core-column-12" id="gdlr-core-column-13">
                            <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="padding: 70px 0px 0px 0px;">
                                ...
                                <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation="fadeInUp" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8">
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                            <i class="gdlr-core-icon-item-icon gdlr-icon-shower" style="color: #212121; font-size: 64px; min-width: 64px; min-height: 64px;"></i>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                            <div class="gdlr-core-title-item-title-wrap">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 20px; font-weight: 500; letter-spacing: 0px; text-transform: none; color: #000000;">
                                                    Shower<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 20px;" id="gdlr-core-title-item-4">
                                                        <div class="gdlr-core-title-item-title-wrap">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title hotale-additional-font class-test" style="font-size: 80px; font-weight: 400; letter-spacing: 0px; text-transform: none; color: #000000;">
                                                                Visit Our Gallery<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="padding: 0px 0px 20px 0px;">
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" style="max-width: 760px;">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align gdlr-core-no-p-space" style="padding-bottom: 0px;">
                                                        <div class="gdlr-core-text-box-item-content" style="font-size: 21px; font-weight: 400; letter-spacing: 0px; text-transform: none; color: #898989;">
                                                            <p>The villa gallery showcases stunning images of our luxurious accommodations and beautiful surroundings. Explore the elegant interiors, breathtaking views, and top-notch facilities that make our villa the perfect getaway.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="gdlr-core-pbf-wrapper" style="padding: 0px 0px 63px 0px;" id="gdlr-core-wrapper-7">
                            ...
                            <div class="gdlr-core-pbf-background-wrap" style="top: -10px;">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(upload/grey-color.jpg); background-repeat: no-repeat; background-position: top center;" data-parallax-speed="0.1"></div>
                            </div>
                            <div class="gdlr-core-pbf-wrapper-content gdlr-core-js">
                                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image gdlr-core-image-item-style-round" style="border-width: 0px; border-radius: 20px; -moz-border-radius: 20px; -webkit-border-radius: 20px;">
                                                            <img src="<?php echo base_url('asset/images/foto1.png') ?>" alt="" width="1300" height="716" title="chef-cook" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 35px;">
                                                        <div class="gdlr-core-title-item-title-wrap">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 30px; font-weight: 500; letter-spacing: 0px; line-height: 1.6; text-transform: none; color: #000000;">
                                                                Beautiful Swimming Pool, To relax your body<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px;">
                                                        <div class="gdlr-core-text-box-item-content" style="font-size: 18px; font-weight: 400; text-transform: none; color: #898989;">
                                                            <p>A swimming pool's beauty lies in its serene and inviting nature. The shimmering blue water reflects sunlight, creating a sparkling effect that soothes and captivates the eyes.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation="fadeInLeft" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                                        <div class="gdlr-core-title-item-title-wrap">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 30px; font-weight: 500; letter-spacing: 0px; line-height: 1.6; text-transform: none; color: #000000;">
                                                                Luxury Room, best experience for you<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px;">
                                                        <div class="gdlr-core-text-box-item-content" style="font-size: 18px; font-weight: 400; text-transform: none; color: #898989;">
                                                            <p>
                                                                A luxury room exudes elegance and comfort, designed to provide an exceptional experience. It often features sophisticated decor, high-quality furnishings, and top-notch amenities.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin: 110px 0px 0px 0px; border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;">
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image gdlr-core-image-item-style-round" style="border-width: 0px; border-radius: 20px; -moz-border-radius: 20px; -webkit-border-radius: 20px;">
                                                            <img src="<?php echo base_url('asset/images/foto2.png') ?>" alt="" width="1300" height="716" title="bar" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin: 110px 0px 0px 0px; border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;">
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image gdlr-core-image-item-style-round" style="border-width: 0px; border-radius: 20px; -moz-border-radius: 20px; -webkit-border-radius: 20px;">
                                                            <img src="<?php echo base_url('asset/images/bawah.png') ?>" alt="" width="1300" height="716" title="spa" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin-top: 0px; padding: 160px 0px 37px 55px;">
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation="fadeInRight" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8">
                                                    ...
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                                        <div class="gdlr-core-title-item-title-wrap">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 30px; font-weight: 500; letter-spacing: 0px; text-transform: none; color: #000000;">
                                                                Beautiful View<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px;">
                                                        <div class="gdlr-core-text-box-item-content" style="font-size: 18px; font-weight: 400; text-transform: none; color: #898989;">
                                                            <p>Our villa epitomizes elegance and tranquility, offering a harmonious blend of modern luxury and natural beauty.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="gdlr-core-pbf-wrapper" id="gdlr-core-wrapper-9">
                            ...
                            <div class="gdlr-core-pbf-background-wrap" style="top: 120px;">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(upload/home-resort-newsletter-bg.png); background-repeat: repeat-x; background-position: top center;" data-parallax-speed="0"></div>
                            </div>
                            <div class="gdlr-core-pbf-wrapper-content gdlr-core-js">
                                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style="padding-bottom: 45px;" id="gdlr-core-title-item-7">
                                                        ...
                                                        <span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 18px; font-style: normal; letter-spacing: 0px; color: #898989; margin-top: 15px;">
                                                            For more information, text us on whatsapp
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-newsletter-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-style-curve3">
                                                        ...
                                                        <div class="newsletter newsletter-subscription">
                                                            ...
                                                            <form class="gdlr-core-newsletter-form clearfix" method="post" onsubmit="return sendToWhatsApp(this)">
                                                                <div class="gdlr-core-newsletter-email">
                                                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 h-20 text-gray-700 leading-tight focus:outline-none focus:shadow-outline rounded-3xl" placeholder="Please Text in here" type="text" name="ne" size="30" required />
                                                                </div>
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                                                ...
                                                                <li>
                                                                    <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                        <a class="gdlr-core-lightgallery gdlr-core-js" href="upload/shutterstock_1298236804.jpg" data-lightbox-group="gdlr-core-img-group-1">
                                                                            <img src="<?php echo base_url('asset/images/ss1.png') ?>" alt="" width="600" height="600" title="shutterstock_1298236804" />
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                        <a class="gdlr-core-lightgallery gdlr-core-js" href="upload/jen-p-541467-unsplash-scaled.jpg" data-lightbox-group="gdlr-core-img-group-1">
                                                                            <img src="<?php echo base_url('asset/images/ss2.png') ?>" alt="" width="600" height="600" title="jen-p-541467-unsplash" />
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                        <a class="gdlr-core-lightgallery gdlr-core-js" href="upload/shutterstock_1386982532.jpg" data-lightbox-group="gdlr-core-img-group-1">
                                                                            <img src="<?php echo base_url('asset/images/ss3.png') ?>" alt="" width="600" height="600" title="shutterstock_1386982532" />
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                        <a class="gdlr-core-lightgallery gdlr-core-js" href="upload/mutzii-1057982-unsplash-scaled.jpg" data-lightbox-group="gdlr-core-img-group-1">
                                                                            <img src="<?php echo base_url('asset/images/ss4.png') ?>" alt="" width="600" height="600" title="mutzii-1057982-unsplash" />
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                        <a class="gdlr-core-lightgallery gdlr-core-js" href="upload/shutterstock_789623335.jpg" data-lightbox-group="gdlr-core-img-group-1">
                                                                            <img src="<?php echo base_url('asset/images/ss5.png') ?>" alt="" width="600" height="600" title="shutterstock_789623335" />
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                        <a class="gdlr-core-lightgallery gdlr-core-js" href="upload/roberto-nickson-YCW4BEhKluw-unsplas.jpg" data-lightbox-group="gdlr-core-img-group-1">
                                                                            <img src="<?php echo base_url('asset/images/ss6.png') ?>" alt="" width="600" height="600" title="roberto-nickson-YCW4BEhKluw-unsplas" />
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                                                        <a class="gdlr-core-lightgallery gdlr-core-js" href="upload/shutterstock_1061669315.jpg" data-lightbox-group="gdlr-core-img-group-1">
                                                                            <img src="<?php echo base_url('asset/images/ss7.png') ?>" alt="" width="600" height="600" title="shutterstock_1061669315" />
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                                        <a class="gdlr-core-button gdlr-core-button-transparent gdlr-core-center-align gdlr-core-button-no-border" href="https://www.instagram.com/adiabianvi?igsh=dmZ2cTVnMmI2bGd4" target="_blank" style="font-size: 13px; font-style: normal; font-weight: 600; letter-spacing: 4px; color: #000000; text-transform: uppercase;">
    ...
    <script>
        function sendToWhatsApp(form) {
            ...
            var textInput = form.ne.value;

            // Mengencode teks untuk URL
            var encodedText = encodeURIComponent(textInput);

            // Nomor WhatsApp tujuan
            var phoneNumber = "6285739481215";

            // Membuat URL WhatsApp dengan teks
            var whatsappURL = "https://wa.me/" + phoneNumber + "/?text=" + encodedText;
    ...
    <script type="text/javascript" src="<?php echo base_url('asset/js/ui/core.min.js') ?>" id="jquery-ui-core-js"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/ui/datepicker.min.js') ?>" id="jquery-ui-datepicker-js"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url('asset/js/ui/effect.min.js') ?>" id="jquery-effects-core-js"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/tourmaster/tourmaster.js') ?>" id="tourmaster-script-js"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/tourmaster/room/tourmaster-room.js') ?>" id="tourmaster-room-script-js"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/jquery.mmenu.js" id="hotale-jquery-mmenu-js') ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/jquery.superfish.js') ?>" id="hotale-jquery-superfish-js"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/script-core.js" id="hotale-script-core-js') ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/jquery.flexslider-min.js') ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/goodlayers-core/plugins/script.js?ver=1653819908" id="gdlr-core-plugin-js') ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url('asset/js/plugins/goodlayers-core/include/js/page-builder.js?ver=1.3.9" id="gdlr-core-page-builder-js') ?>"></script>
