                ...
                <div class="hotale-logo hotale-item-pdlr">
                    <div class="hotale-logo-inner">
                        <a class="hotale-fixed-nav-logo" href="index.html">
                            <img src="upload/logo-nx1.png" alt="" width="147" height="37" title="logo-nx1" />
                        </a>
                            ...
                            <div class="hotale-navigation hotale-item-pdlr clearfix">
                                <div class="hotale-main-menu" id="hotale-main-menu">
                                    <ul id="menu-main-navigation-1" class="sf-menu">
                                        ...
                                        <li class="menu-item hotale-normal-menu current-menu-item"><a href="<?php echo base_url('contact') ?>" class="sf-with-ul-pre">Contact</a></li>
                                    </ul>
                ...
                <div class="gdlr-core-page-builder-body">
                    <div class="gdlr-core-pbf-wrapper gdlr-core-wrapper-full-height gdlr-core-js gdlr-core-full-height-center" style="margin: 0px 0px 0px 0px; padding: 280px 0px 80px 0px; border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;" id="gdlr-core-wrapper-1" data-decrease-height="40px">
                        <div class="gdlr-core-pbf-background-wrap" style="border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;">
                            <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url('asset/images/ab10.jpg'); background-size: cover; background-position: center;" data-parallax-speed="0"></div>
                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                                    <div class="gdlr-core-text-box-item-content" style="font-size: 22px; font-weight: 400; text-transform: none; color: #ffffff;">
                                                        <p>For More Information, You Can Follow Our Social Media</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="py-8 bg-gray-800">
            <div class="container mx-auto flex flex-wrap">
                ...
                <div class="w-full md:w-1/3 p-4">
                    <div class="bg-gray-700 p-6 rounded-lg text-white animate__animated animate__fadeInUp">
                        <div class="flex items-center mb-4">
                            <div class="bg-white p-5 rounded-full">
                                <i class="fa fa-phone text-gray-900 text-3xl"></i>
                            </div>
                        </div>
                ...
                <!-- Email Section -->
                <div class="w-full md:w-1/3 p-4">
                    <div class="bg-gray-700 p-6 rounded-lg text-white animate__animated animate__fadeInDown">
                        <div class="flex items-center mb-4">
                            <div class="bg-white p-5 rounded-full">
                                <i class="fa fa-envelope text-gray-900 text-3xl"></i>
                            </div>
                        </div>
                        <h3 class="text-xl mb-2" style="color: white;">Email</h3>
                        <p class="text-white-400 mb-4">If you have any questions or need further information, please feel free to contact us at</p>
                        <a href="mailto:adiabianvilla@gmail.com" style="color: white; text-decoration: underline;">adiabianvilla@gmail.com</a>
                    </div>
                </div>
                <!-- Location Section -->
                <div class="w-full md:w-1/3 p-4">
                    <div class="bg-gray-700 p-6 rounded-lg text-white animate__animated animate__fadeInUp">
                        <div class="flex items-center mb-4">
                            <div class="bg-white p-5 rounded-full">
                                <i class="fa fa-location-arrow text-gray-900 text-3xl"></i>
                            </div>
                        </div>
                        <h3 class="text-xl mb-2" style="color: white;">Location</h3>
                        <p class="text-white-400 mb-4">
                            Jl. Raya Uluwatu Pecatu No.108, Pecatu,<br />
                            Kec. Kuta Sel., Kabupaten Badung, Bali 80361
                        </p>
                        <a href="https://www.google.co.id/maps/place/Adi+Abian+Villa/@-8.8357013,115.1185048,17z/data=!3m1!4b1!4m9!3m8!1s0x2dd25befb1b0cc91:0x2787fa2658a1151b!5m2!4m1!1i2!8m2!3d-8.8357013!4d115.1210797!16s%2Fg%2F11fs02_tv8?hl=id&entry=ttu" style="color: white; text-decoration: underline;">View On Google Map</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style="padding-bottom: 60px;">
                                        <div class="gdlr-core-title-item-title-wrap">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 39px; font-weight: 600; letter-spacing: 0px; text-transform: none;">
                                                LOOK IN MAPS <span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                            </h3>
                                        </div>
                                        <span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 19px; font-style: normal; letter-spacing: 0px;">
                                            for details located, look in map.
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-wp-google-map-plugin-item gdlr-core-item-pdlr gdlr-core-item-pdb" style="padding-bottom: 0px;">
                            <div class="wpgmp_map_container wpgmp-map-1" rel="map1">
                                <iframe style="width:100%; height:500px; border:0; margin-bottom: -9px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3942.4709413369947!2d115.11858702629675!3d-8.835669486670803!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd25befb1b0cc91%3A0x2787fa2658a1151b!2sAdi%20Abian%20Villa!5e0!3m2!1sid!2sid!4v1721217659852!5m2!1sid!2sid" width="600" height="450"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
