...
<head>
    ...
    <title>ADI ABIAN VILLA | HOME</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('asset/css/iconfont.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('asset/css/slick/slick.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('asset/css/slick/slick-theme.css') ?>">
    ...
    <link rel="stylesheet" href="<?php echo base_url('asset/css/plugins.css') ?>" />
            ...
            <div class="row">
                <div class="main_blog sections">
                    <div class="head_title text-center">
                        <h2>GALLERY</h2>
                        <div class="subtitle">
                            Look the best villa in uluwatu in middle class
                        </div>
                        <div class="separator"></div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 no-padding">
                                        <div class="single_blog_img">
                                            <img src="<?php echo base_url('asset/images/ab2.jpg') ?>" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6 no-padding">
                        ...
                        <div class="col-sm-6">
                            <div class="single_blog_area textwhite">
                                <div class="row">
                                    <div class="col-sm-6 no-padding">
                                        <div class="single_blog_img">
                                            <img src="<?php echo base_url('asset/images/ab6.jpg') ?>" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6 no-padding">
                                        <div class="single_blog_text s_b_left">
                                            <p>lobby/front office</p>
                                            <h3>LOBBY</h3>
                                            <div class="separator2"></div>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                industry. Lorem Ipsum has been the indu Stry's
                        ...
                        <div class="col-sm-6">
                            <div class="single_blog_area textwhite">
                                <div class="row">
                                    <div class="col-sm-6 col-sm-push-6 no-padding">
                                        <div class="single_blog_img">
                                            <img src="<?php echo base_url('asset/images/ab3.jpg') ?>" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-sm-pull-6 no-padding">
                                        <div class="single_blog_text s_b_right">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="single_contact_info">
                                                    <div class="single_info_text">
                                                        <h3>OUR ADDRESS</h3>
                                                        <h4>Jalan Raya Uluwatu Pecatu, Uluwatu, Kuta Selatan, Badung</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                ...
                <div class="container">
                    <div class="row">
                        <div class="main_trial">
                            <div class="col-sm-12">
                                <h2>Let's book now. <span>enjoy your HOLIDAY!</span></h2>
                                <h4>save your moments in Bali with happines, because you never know when you die.</h4>
                                <a href="" class="btn btn-lg">BOOK NOW</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main_footer">
                        <div class="row">
                            ...
                            <div class="copyright_text">
                                <p class=" wow fadeInRight" data-wow-duration="1s">PBL VILLA by <a href="https://bootstrapthemes.co">Vian Gank </a>2024.</p>
                            </div>
                        </div>
                    </div>
                </div>
