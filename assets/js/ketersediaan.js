                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.availability.forEach(function(room) {
                            var checkin = room.tgl_checkIn;
                            var checkout = room.tgl_checkOut;
                            console.log();
                            ...
                            var roomRow = '<tr>' +
                                ...
                                '<td class="border border-gray-500 px-4 py-2">' + checkin + '</td>' +
                                '<td class="border border-gray-500 px-4 py-2">' + checkout + '</td>' +
                                '</td>' +
                                '</tr>';
